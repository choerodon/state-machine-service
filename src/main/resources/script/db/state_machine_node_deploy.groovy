...
databaseChangeLog(logicalFilePath: 'script/db/state_machine_node_deploy.groovy') {
    changeSet(author: 'shinan.chenX@gmail.com', id: '2018-07-30-state-machine-node-deploy') {
        ...
        createIndex(tableName: "state_machine_node_deploy", indexName: "state_machine_node_deploy_n3") {
